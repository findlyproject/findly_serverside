...
import { AllCommunities, CommunityDetails, communitymesgById, CommunitySendMessage, createCommunity, deletecommunitymessage, GetConversation, joinCommunity, LeaveCommunity, SearchCommunity, SendMessage } from '../Controller/messsageController/message'
...
.get('/search',errorCatch(SearchCommunity))
