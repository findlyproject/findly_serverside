...
const SubscriptionPlanSchema = new Schema <ISubscription>({
 ...
 companyId: { type: mongoose.Schema.Types.ObjectId, ref: "Company", required: false },
  ...
  startDate: { type: Date },
  endDate: { type: Date },
  type: { type: String, required: true, enum: ["UserSubscription", "CompanySubscription"] },
  paymentStatus:{type:String,required:true, default: "pending",enum:["pending","completed"]},
},
